function returnProps() {
	return ['prop_value', 'sales_line_item', 'dsh_data', 'detail_data', 'config_scheme_options'];
}
...
function returnMounted() {
	return function () {
		...
		if (this.sales_line_item
			&& this.sales_line_item.config_scheme) {
			this.fromConfigSelection.sch_id = this.sales_line_item.config_scheme.sch_id
		}
