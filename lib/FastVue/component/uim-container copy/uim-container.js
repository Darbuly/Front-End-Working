function returnProps() {
	return ['prop_value', 'template_id', "width", "height", "id_key"];
}
	...
	return {
		...
		pushContainer: async function (parentItemDic, parentContainerId) {
			...
			if (!finalParentItemDic['template_children'][this.template_id]) {
				...
				("undefined" != typeof addOneCtrl) && addOneCtrl('senior_containerAutoHeight', { ...default_container, "parentContainerId": parentContainerId });
				await this.waitCtrl();
				...
				if ("undefined" != typeof addOneCtrl) {
					addOneCtrl('senior_containerAutoHeight', { ...setting_container, "parentContainerId": parentContainerId });
				}
				if ("undefined" != typeof parentV) {
