...
rui.define(['vue'], function (exports) {
	"use strict";
	...
	var Vue = rui.vue
		...
		//字符常量
		, STR_ELEM = 'rui-demo_vue', STR_HIDE = 'rui-hide', STR_DISABLED = 'rui-disabled', STR_NONE = 'rui-none'
	...
	//重载实例
	demo_vue.reload = function (id, options) {
		var that = thisModule.that[id];
		that.reload(options);
	...
	//核心入口
	demo_vue.render = function (options) {
		var inst = new Class(options);
		return thisModule.call(inst);
	};

	exports(MOD_NAME, demo_vue);
});
