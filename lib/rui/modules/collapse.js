...
rui.define(['vue', 'el-collapse'], function (exports) {
	"use strict";
	...
	var Vue = rui.vue
		...
		, Class = function (options) {
			...
			//加载 css
			rui.addcss('modules/collapse.css')
			that.render();
		};
	...
	//重载实例
	collapse.reload = function (id, options) {
		var that = thisModule.that[id];
		that.reload(options);
	...
	//核心入口
	collapse.render = function (options) {
		var inst = new Class(options);
		return thisModule.call(inst);
	};

	exports(MOD_NAME, collapse);
});
