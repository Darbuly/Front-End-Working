  ...
  var has3d,
    ...
    turnMethods = {
      ...
      _touchEnd: function () {
        ...
        var data = this.data();
        //below added by Wangwenwei 20220411:
        console.log(data.f);
        //end added
        for (var page in data.pages) {
          if (has(page, data.pages)) {
    ...
    flipMethods = {
      ...
      _isIArea: function (e) {
        ...
        //below added by Wangwenwei 20220411: 记录开始时的坐标
        this.data().f.start_x = e.pageX;
        this.data().f.start_y = e.pageY;
        //end added
      ...
      _eventMove: function (e) {
        ...
        if (!data.disabled) {
          ...
          if (data.corner) {
            ...
            // console.log('_eventMove data.corner')
            ...
            if (point) {
              // console.log('_eventMove if point')
              ...
              console.log('_eventMove_eventMove if not point')
              console.log(e);
